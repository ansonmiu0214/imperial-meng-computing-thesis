...
\fz{Mention correctness by construction instead of verifying conformance?}
...
running example in this section. \fz{What do you try to say in the next
  sentence?} For server-side targets, we encode
