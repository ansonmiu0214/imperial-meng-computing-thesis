...
This motivates our design choice of generating different session types
...
unused states. Equally, our approach cannot prevent a client closing the browser, which would drop the connection.
