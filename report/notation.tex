...
\newcommand{\sel}[3]{
{\mrole{#1} \lhd {#2} \langle {#3} \rangle }
}
\newcommand{\bra}[3]{
{\mrole{#1} \rhd \left\{ {#2} \right\}_{#3}}
}
\newcommand{\ptprocess}[2]{
{\mrole{#1} :: {#2}}
}
\newcommand{\precvar}{X}
\newcommand{\precursion}[1]{
\mu\precvar . {#1}
}
\newcommand{\pcond}[3]{
...
\newcommand{\gtransone}[3]{
\mrole{#1} \rightsquigarrow \mrole{#2} :  ~ {#3} ~
}
\newcommand{\wf}[1]{
...
\newcommand{\gtransrouteone}[4]{
\mrole{#1} \underset{\mrole{#3}}{\rightsquigarrow} \mrole{#2}: ~ {#4} ~
}
\newcommand{\wfnew}[2]{
...
\mrole{#1} \hookrightarrow \mrole{#2}: {#3}~.~{#4}
}
