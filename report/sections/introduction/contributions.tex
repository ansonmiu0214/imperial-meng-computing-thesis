...
\emph{server-centric} communication protocols over WebSockets. 
Server-centric 
protocols feature exactly one server role that is involved in all 
interactions.
...
we extend \fancyname{SessionTS} to support advanced
